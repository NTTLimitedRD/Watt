...
namespace DD.Cloud.WebApi.TemplateToolkit
{
	...
	public sealed class HttpClientBuilder
	{
		...
		/// </returns>
		[SuppressMessage("Microsoft.Reliability", "CA2000:Dispose objects before losing scope", Justification = "Rule is wrong, handlers are disposed on exception.")]
		public HttpClient CreateClient(Uri baseUri = null)
		{
			...
			try
			{
				...
				pipeline = HttpClientFactory.CreatePipeline(pipelineTerminus, pipelineHandlers);
